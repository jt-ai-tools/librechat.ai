...
title: together.ai
icon: TogetherAI
description: together.ai 的配置範例
---

> together.ai API 金鑰：[api.together.xyz/settings/api-keys](https://api.together.xyz/settings/api-keys)

**備註：**

- **已知 (Known)**：已提供圖標。
- **已知問題**：不支援動態獲取模型列表。
- 為了方便起見，此範例包含了一個模型清單，最後更新於 2024 年 8 月 1 日。
